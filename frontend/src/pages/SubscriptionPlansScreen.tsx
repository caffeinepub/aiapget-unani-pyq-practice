...
export default function SubscriptionPlansScreen({ onNavigate }: SubscriptionPlansScreenProps) {
    ...
    <div className="min-h-screen bg-background flex flex-col">
      <main className="flex-1 max-w-2xl mx-auto w-full px-4 py-6 space-y-6">
        ...
        <div className="grid grid-cols-1 sm:grid-cols-2 gap-4">
          ...
          <div
            onClick={() => setSelectedPlan('monthly')}
            className={`relative bg-card border-2 rounded-2xl p-5 cursor-pointer transition-all duration-200 ${
              selectedPlan === 'monthly'
          ...
          >
            <div className="flex items-center gap-2 mb-3">
              ...
              <h3 className="font-heading font-bold text-foreground">{MONTHLY_PLAN.name}</h3>
            </div>
            <div className="mb-4">
          ...
          >
            ...
            <div className="flex items-center gap-2 mb-3 mt-1">
              ...
              <h3 className="font-heading font-bold text-foreground">{YEARLY_PLAN.name}</h3>
            </div>
            <div className="mb-1">
              <span className="text-3xl font-heading font-bold text-foreground">
