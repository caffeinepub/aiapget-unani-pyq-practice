      ...
      <main className="flex-1 max-w-4xl mx-auto w-full px-4 py-6 space-y-6">
        ...
        <section className="relative rounded-2xl overflow-hidden shadow-lg">
          ...
          <div className="absolute inset-0 bg-gradient-to-r from-primary/80 to-transparent flex flex-col justify-end p-5">
            ...
            <p className="text-primary-foreground/90 text-sm mt-1 font-body max-w-xs">
              Practice with {allQuestions.length}+ authentic AIAPGET previous year questions
            </p>
          </div>
        </section>
        ...
        <section className="grid grid-cols-3 gap-3">
          {[
            ...
            >
              <div className="text-xl font-bold text-gold font-heading">{stat.value}</div>
            ...
            {navCards.map((card) => (
              ...
              >
                ...
                <div className="flex-1 min-w-0">
                  ...
                  <div className="text-xs text-muted-foreground font-body mt-0.5">{card.desc}</div>
                </div>
        ...
        <section className="bg-card border border-border rounded-xl p-5 shadow-xs">
          <div className="flex items-center gap-2 mb-3">
            ...
            <h3 className="font-heading font-semibold text-foreground">About AIAPGET</h3>
          </div>
          <p className="text-sm text-muted-foreground font-body leading-relaxed">
            The All India Ayush Post Graduate Entrance Test (AIAPGET) is a national-level entrance
            examination for admission to postgraduate courses in Ayurveda, Unani, Siddha, and
            Homeopathy. This app focuses on the{' '}
            <strong className="text-foreground">Unani System of Medicine</strong>, covering subjects
            like Kulliyat, Ilmul Advia, Moalijat, Tashreeh, and more.
          </p>
        </section>
      </main>
