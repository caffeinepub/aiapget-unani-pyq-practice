...
import { ChevronLeft, BookOpen, Play, ChevronDown, ChevronUp, Loader2 } from 'lucide-react';
import { Button } from '@/components/ui/button';
import { TOPICS, YEARS, type Question } from '../data/questions';
...
export default function TopicBrowserScreen({ onStartQuiz, onBack }: TopicBrowserScreenProps) {
    ...
    <div className="min-h-screen bg-background flex flex-col">
      <header className="bg-primary text-primary-foreground shadow-md sticky top-0 z-10">
        <div className="max-w-2xl mx-auto px-4 py-3 flex items-center gap-3">
          ...
          <h1 className="font-heading font-bold text-base flex-1">Browse Questions</h1>
      ...
      <main className="flex-1 max-w-2xl mx-auto w-full px-4 py-4 space-y-2">
        ...
        {!isLoading && mode === 'topic' &&
          topicData.map(({ topic, questions: topicQs }) => (
            <div key={topic} className="bg-card border border-border rounded-xl overflow-hidden shadow-xs">
              <button
              ...
              >
                ...
                <div className="flex-1 min-w-0">
                  <div className="font-semibold text-foreground font-heading text-sm">{topic}</div>
        ...
        {!isLoading && mode === 'year' &&
          yearData.map(({ year, questions: yearQs }) => (
            <div key={year} className="bg-card border border-border rounded-xl overflow-hidden shadow-xs">
              <button
              ...
              >
                ...
                <div className="flex-1 min-w-0">
                  <div className="font-semibold text-foreground font-heading text-sm">AIAPGET {year}</div>
                  <div className="text-xs text-muted-foreground font-body">
