...
export default function ReviewScreen({ questions, answers, onBack }: ReviewScreenProps) {
      ...
      <header className="bg-primary text-primary-foreground shadow-md sticky top-0 z-10">
        <div className="max-w-2xl mx-auto px-4 py-3 flex items-center gap-3">
          ...
          <Badge
            ...
            className={isCorrect && !isSkipped ? 'bg-success text-white border-0' : ''}
          >
      ...
      <main className="flex-1 max-w-2xl mx-auto w-full px-4 py-6 space-y-4">
        ...
        <div className="bg-card border border-border rounded-2xl p-5 shadow-xs">
          <div className="flex items-start gap-3">
            ...
            <div className="flex-1">
              <p className="text-foreground font-body text-base leading-relaxed">{current.text}</p>
        ...
        {current.explanation && (
          <div className="bg-teal/10 border border-teal/30 rounded-xl p-4">
            ...
            <p className="text-sm text-foreground font-body leading-relaxed">{current.explanation}</p>
          </div>
        )}
